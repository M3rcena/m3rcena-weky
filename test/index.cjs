...
const { Calculator } = require('../dist/Calculator-CQ5R-9sU.cjs');
const {ChaosWords} =  require('../dist/ChaosWords-CGrpyZdw.cjs');
const {FastType} =  require('../dist/FastType-CvS16KZx.cjs');
const {Fight} =  require('../dist/Fight-C7LW1BHR.cjs');
const {GuessTheNumber} =  require('../dist/GuessTheNumber-QmIoxYJA.cjs');
const {GuessThePokemon} =  require('../dist/GuessThePokemon-BBRrlhRF.cjs');
const {LieSwatter} =  require('../dist/LieSwatter-ysxe7wTG.cjs');
const {NeverHaveIEver} =  require('../dist/NeverHaveIEver-BsbfRLP4.cjs');
const {QuickClick} =  require('../dist/QuickClick-Bz67C0Yw.cjs');
const {RockPaperScissors} =  require('../dist/RockPaperScissors-CWf71zZU.cjs');
const {ShuffleGuess} =  require('../dist/ShuffleGuess-Bt5uB3_X.cjs');
const {Snake} =  require('../dist/Snake-Cn9Tw8uZ.cjs');
const {TicTacToe} =  require('../dist/TicTacToe-CWLZJMoT.cjs');
const {Trivia} =  require('../dist/Trivia-DE0KVWOw.cjs');
const {WillYouPressTheButton} =  require('../dist/WillYouPressTheButton-CRm02Ych.cjs');
const {WouldYouRather} =  require('../dist/WouldYouRather-CBZh1MSy.cjs');
