...
export interface guessTheNumber {
	message: Message;
	embed?: {
		title?: string;
		description?: string;
...
export interface guessThePokemon {
	message: Message;
	embed?: {
		title?: string;
		description?: string;
