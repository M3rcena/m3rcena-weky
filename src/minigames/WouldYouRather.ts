...
const WouldYouRather = async (weky: WekyManager, options: CustomOptions<WouldYouRatherTypes>) => {
	...
	let apiData: NewWYRApiResponse;

	try {
		apiData = await ofetch<NewWYRApiResponse>(
