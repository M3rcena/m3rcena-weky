...
const WouldYouRather = async (options: WouldYouRatherTypes) => {
    ...
    if (!message) throw new Error(chalk.red("[@m3rcena/weky] WouldYouRather Error:") + " No message provided.");

    if (!message.channel || !message.channel.isSendable()) throw new Error(chalk.red("[@m3rcena/weky] WouldYouRather Error:") + " No channel provided in message.");
