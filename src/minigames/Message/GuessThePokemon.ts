...
const GuessThePokemon = async (options: GuessThePokemonTypes) => {
    ...
    if (!message) throw new Error(chalk.red("[@m3rcena/weky] GuessThePokemon Error:") + " No Message provided.");

    if (!message.channel || !message.channel.isSendable()) throw new Error(chalk.red("[@m3rcena/weky] GuessThePokemon Error:") + " No channel found.");
