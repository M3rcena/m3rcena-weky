...
const LieSwatter = async (options: LieSwatterTypes) => {
    ...
    if (!message) throw new Error(chalk.red("[@m3rcena/weky] LieSwatter Error:") + " No message provided.");

    if (!message.channel || !message.channel.isSendable()) throw new Error(chalk.red("[@m3rcena/weky] LieSwatter Error:") + " No channel found.");
