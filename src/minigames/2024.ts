...
export default class mini2048 implements IMinigame {
	...
	private options: CustomOptions<Types2048>;
	private context: CustomOptions<Types2048>["context"];
	 ...
	 * @private
	 */
	private async endGame(state: "won" | "gameover" | "quit" | "timeout" | "error", details?: { error?: string }) {
	 ...
	 * @private
	 */
	private mapDirection(customId: string): string {
		switch (customId) {
			case "weky_2048_up":
				return "UP";
			case "weky_2048_down":
