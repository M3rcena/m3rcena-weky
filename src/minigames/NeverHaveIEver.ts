...
export default class NeverHaveIEver implements IMinigame {
	...
	private options: CustomOptions<NeverHaveIEverTypes>;
	private context: CustomOptions<NeverHaveIEverTypes>["context"];
	 ...
	 * @private
	 */
	private async endGame(state: "yes" | "no" | "timeout" | "error", errorMsg?: string) {
