 ...
 */
var GuessTheNumber = (options) => index.__awaiter(void 0, void 0, void 0, function* () {
    if (!options.message) {
    ...
    if (parseInt(options.time) < 10000) {
        throw new Error(`${chalk.red('Weky Error:')} time argument must be greater than 10 Seconds (in ms i.e. 10000).`);
    }
    ...
    if (options.publicGame) {
        ...
        if (currentGames[options.message.guild.id]) {
            const embed = new discord_js.EmbedBuilder()
                .setDescription(options.ongoingMessage.replace(/{{channel}}/g, currentGames[`${options.message.guild.id}_channel`]))
        ...
        const embed = new discord_js.EmbedBuilder()
            .setDescription(`${options.embed.description.replace(/{{time}}/g, _function.convertTime(options.time))}`)
        ...
        let btn1 = new discord_js.ButtonBuilder()
            ...
            .setCustomId(id);
        const msg = yield options.message.reply({
            embeds: [embed],
        ...
        collector.on('collect', (_msg) => index.__awaiter(void 0, void 0, void 0, function* () {
            ...
            if (parsedNumber === options.number) {
                ...
                const _embed = new discord_js.EmbedBuilder()
                    .setDescription(`${options.winMessage.publicGame
                ...
                if (options.returnWinner) {
                    ...
                    db.set(`GuessTheNumber_${options.message.guild.id}_${options.gameID}`, _msg.author.id);
                }
            }
            if (parseInt(_msg.content) < options.number) {
                const _embed = new discord_js.EmbedBuilder()
                    .setDescription(options.bigNumberMessage
            ...
            if (parseInt(_msg.content) > options.number) {
                const _embed = new discord_js.EmbedBuilder()
                    .setDescription(options.smallNumberMessage
                    .replace(/{{author}}/g, _msg.author.toString())
                    .replace(/{{number}}/g, parsedNumber))
                    .setAuthor({ name: options.message.author.username, iconURL: options.message.author.displayAvatarURL() })
                    .setFooter({ text: options.embed.footer });
        ...
        gameCollector.on('collect', (button) => index.__awaiter(void 0, void 0, void 0, function* () {
            if (button.user.id !== options.message.author.id) {
                return button.reply({
                    content: options.othersMessage.replace(/{{author}}/g, options.message.member.id),
                    ephemeral: true,
                });
            }
            ...
            if (button.customId === id) {
                ...
                const _embed = new discord_js.EmbedBuilder()
                    .setTitle(options.embed.title)
                    .setDescription(options.loseMessage.replace(/{{number}}/g, options.number))
                    .setAuthor({ name: options.message.author.username, iconURL: options.message.author.displayAvatarURL() })
                    .setFooter({ text: options.embed.footer });
                if (options.embed.timestamp) {
                    _embed.setTimestamp();
        ...
        collector.on('end', (_collected, reason) => index.__awaiter(void 0, void 0, void 0, function* () {
        ...
        collector.on('collect', (_msg) => index.__awaiter(void 0, void 0, void 0, function* () {
            if (_msg.author.id !== options.message.author.id)
                return;
            if (isNaN(_msg.content)) {
                return;
            }
            ...
            if (parsedNumber === options.number) {
                const time = _function.convertTime(Date.now() - gameCreatedAt);
                const _embed = new discord_js.EmbedBuilder()
                    .setDescription(`${options.winMessage.privateGame
                    .replace(/{{time}}/g, time)
                    .replace(/{{number}}/g, options.number)}`)
                    .setTitle(options.embed.title)
                    .setAuthor({ name: options.message.author.username, iconURL: options.message.author.displayAvatarURL() })
