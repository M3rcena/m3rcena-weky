...
const Fight = async (options) => {
    ...
    let component = new ActionRowBuilder().addComponents([acceptButton, denyButton]);
    ...
    collector.on("collect", async (_btn) => {
        ...
        if (_btn.customId === "weky_deny") {
            ...
            denyButton = new ButtonBuilder()
                ...
                .setLabel(options.buttons.deny)
                .setCustomId("weky_deny");
            component = new ActionRowBuilder().addComponents([acceptButton, denyButton]);
                        ...
                        if (btn.customId === id1) {
                            ...
                            if (gameData[player].health < 50) {
                                ...
                                btn3 = new ButtonBuilder()
                                    ...
                                    .setLabel(options.buttons.cancel)
                                    .setCustomId(id3);
                                row = new ActionRowBuilder().addComponents([btn1, btn2, btn3]);
                                gameCollector.stop();
                                data.delete(id);
                                data.delete(opponent.id);
                                let __embed = new EmbedBuilder()
