import { ContainerBuilder, LabelBuilder, MessageFlags, ModalBuilder, TextDisplayBuilder, TextInputBuilder, TextInputStyle, } from "discord.js";
...
export default class Calculator {
    ...
    async handleModal(interaction, config) {
        ...
        const input = new TextInputBuilder()
            ...
            .setRequired(true);
        const textDisplay = new TextDisplayBuilder().setContent(this.options.modals?.display
