...
import { ActionRowBuilder, ComponentType, ContainerBuilder, EmbedBuilder, MessageFlags, ModalBuilder, TextInputBuilder, TextInputStyle } from "discord.js";
...
const Calculator = async (options) => {
    ...
    // Message-based calculator setup using Components V2
