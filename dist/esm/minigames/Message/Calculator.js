...
import { ActionRowBuilder, ComponentType, EmbedBuilder, MessageFlags, ModalBuilder, TextInputBuilder, TextInputStyle } from "discord.js";
import { evaluate } from "mathjs";
import { addRow, checkPackageUpdates, createButton, createDisabledButton, createEmbed } from "../../functions/functions.js";
...
const Calculator = async (options) => {
    ...
    if (!message)
        throw new Error(chalk.red("[@m3rcena/weky] Calculator Error:") + " No message provided.");
