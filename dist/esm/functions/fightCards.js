...
// Request Card
export async function getRequestCard(challenger, opponent) {
...
// Main Card
export async function getMainCard(player1, player2) {
    const canvas = new Canvas(800, 800); // Square aspect ratio
    const ctx = canvas.getContext('2d');
    // Create gradient background
    const gradient = ctx.createLinearGradient(0, 0, 800, 800);
...
// Surrender Card
export async function getSurrenderCard(player, winner) {
...
// Denied Card
export async function getDeniedCard(challenger, opponent) {
    const canvas = new Canvas(800, 800);
    const ctx = canvas.getContext('2d');
    // Background
    const gradient = ctx.createLinearGradient(0, 0, 800, 800);
...
// Timeout Card
export async function getTimeoutCard(challenger, opponent) {
    const canvas = new Canvas(800, 800);
    const ctx = canvas.getContext('2d');
    // Background
    const gradient = ctx.createLinearGradient(0, 0, 800, 800);
