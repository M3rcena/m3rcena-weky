...
export function OptionsChecking(options, GameName) {
    ...
    if (options.embed.title) {
        if (typeof options.embed.title !== "string")
            throw new TypeError(chalk.red(`[@m3rcena/weky] ${GameName} Error:`) + " Embed title must be a string.");
    ...
    if (options.embed.url) {
        if (typeof options.embed.url !== "string")
            throw new TypeError(chalk.red(`[@m3rcena/weky] ${GameName} Error:`) + " Embed URL must be a string.");
    ...
    if (options.embed.author) {
        ...
        if (options.embed.author.icon_url) {
            if (typeof options.embed.author.icon_url !== "string")
                throw new TypeError(chalk.red(`[@m3rcena/weky] ${GameName} Error:`) + " Embed author icon URL must be a string.");
        ...
        if (options.embed.author.url) {
            if (typeof options.embed.author.url !== "string")
                throw new TypeError(chalk.red(`[@m3rcena/weky] ${GameName} Error:`) + " Embed author URL must be a string.");
        ...
        for (const field of options.embed.fields) {
            ...
            if (field.name) {
                if (typeof field.name !== "string")
                    throw new TypeError(chalk.red(`[@m3rcena/weky] ${GameName} Error:`) + " Field name must be a string.");
            ...
            if (field.value) {
                if (typeof field.value !== "string")
                    throw new TypeError(chalk.red(`[@m3rcena/weky] ${GameName} Error:`) + " Field value must be a string.");
    ...
    if (options.embed.image) {
        if (typeof options.embed.image !== "string")
            throw new TypeError(chalk.red(`[@m3rcena/weky] ${GameName} Error:`) + " Embed image must be a string.");
