...
const mini2048 = async (weky, options) => {
    ...
    const createGameContainer = (state, details) => {
        ...
        if (state === "active") {
            const up = new discord_js_1.ButtonBuilder().setStyle(discord_js_1.ButtonStyle.Secondary).setLabel(emojiUp).setCustomId("weky_2048_up");
