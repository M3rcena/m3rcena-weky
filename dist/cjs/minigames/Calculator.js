...
const Calculator = async (weky, options) => {
    ...
    const buildRows = (keys, forceEmpty = false) => {
        const container = new discord_js_1.ContainerBuilder().setAccentColor(accentColor);
    ...
    const handleModal = async (interaction, config) => {
        ...
        const input = new discord_js_1.TextInputBuilder()
            ...
            .setRequired(true);
        const textDisplay = new discord_js_1.TextDisplayBuilder().setContent(options.modals?.display
    ...
    collector.on("collect", async (interaction) => {
        ...
        switch (true) {
            ...
            case id === "cal=":
                ...
                if (result !== null) {
                    lastAnswer = (0, mathjs_1.format)(result, { precision: 14 });
