...
const WillYouPressTheButton = async (options) => {
    ...
    if (!interaction)
        throw new Error(chalk_1.default.red("[@m3rcena/weky] WillYouPressTheButton Error:") + " No interaction provided.");
    if (!interaction.channel || !interaction.channel.isSendable())
        throw new Error(chalk_1.default.red("[@m3rcena/weky] WillYouPressTheButton Error:") + " No channel provided in interaction.");
