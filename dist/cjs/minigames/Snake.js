...
const Snake = async (weky, options) => {
    ...
    const createGameContainer = (state, details) => {
        ...
        if (state === "active") {
            const up = new discord_js_1.ButtonBuilder().setStyle(discord_js_1.ButtonStyle.Primary).setLabel(emojiUp).setCustomId("weky_snake_up");
            const down = new discord_js_1.ButtonBuilder().setStyle(discord_js_1.ButtonStyle.Primary).setLabel(emojiDown).setCustomId("weky_snake_down");
            const left = new discord_js_1.ButtonBuilder().setStyle(discord_js_1.ButtonStyle.Primary).setLabel(emojiLeft).setCustomId("weky_snake_left");
