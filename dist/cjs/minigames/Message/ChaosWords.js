...
const ChaosWords = async (options) => {
    ...
    if (!message.channel)
        throw new Error(chalk_1.default.red("[@m3rcena/weky] ChaosWords Error:") + " No channel found on Message.");
    if (!message.channel.isSendable())
        throw new Error(chalk_1.default.red("[@m3rcena/weky] ChaosWords Error:") + " Channel is not sendable.");
    if (message.channel.isDMBased())
        throw new Error(chalk_1.default.red("[@m3rcena/weky] ChaosWords Error:") + " Channel is a DM.");
