...
const mini2048 = async (options) => {
    ...
    if (!message)
        throw new Error(chalk_1.default.red("[@m3rcena/weky] 2048 Error:") + " No message provided.");
    let client = options.client;
    if (!message.channel)
        throw new Error(chalk_1.default.red("[@m3rcena/weky] 2048 Error:") + " No channel found on Message.");
    if (!message.channel.isSendable())
        throw new Error(chalk_1.default.red("[@m3rcena/weky] 2048 Error:") + " Channel is not sendable.");
    if (!message.guild)
        throw new Error(chalk_1.default.red("[@m3rcena/weky] 2048 Error:") + " No guild found on Message.");
    ...
    const stop = new discord_js_1.ButtonBuilder().setStyle(discord_js_1.ButtonStyle.Danger).setLabel("Quit Game").setCustomId("weky_quit").setEmoji("🛑");
