...
const ShuffleGuess = async (options) => {
    ...
    if (!message.channel || !message.channel.isSendable())
        throw new Error(chalk_1.default.red("[@m3rcena/weky] FastType Error:") + " No channel provided in message.");
    ...
    (0, functions_js_1.checkPackageUpdates)("ShuffleGuess", options.notifyUpdate);
};
