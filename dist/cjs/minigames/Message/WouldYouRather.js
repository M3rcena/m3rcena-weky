...
const WouldYouRather = async (options) => {
    ...
    if (!message)
        throw new Error(chalk_1.default.red("[@m3rcena/weky] WouldYouRather Error:") + " No message provided.");
    if (!message.channel || !message.channel.isSendable())
        throw new Error(chalk_1.default.red("[@m3rcena/weky] WouldYouRather Error:") + " No channel provided in message.");
