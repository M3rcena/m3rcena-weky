...
exports.OptionsChecking = OptionsChecking;
...
function OptionsChecking(options, GameName) {
    ...
    if (typeof options.interaction !== "object") {
        throw new Error(chalk_1.default.red(`[@m3rcena/weky] ${GameName} TypeError:`) + " Interaction must be an object.");
    }
    ;
    if (!options.client)
    ...
    if (typeof options.embed !== "object") {
        throw new Error(chalk_1.default.red(`[@m3rcena/weky] ${GameName} Error:`) + " Embed options must be an object.");
    }
    ;
    ...
    if (options.embed.title) {
        if (typeof options.embed.title !== "string")
            throw new Error(chalk_1.default.red(`[@m3rcena/weky] ${GameName} Error:`) + " Embed title must be a string.");
    ...
    if (options.embed.url) {
        if (typeof options.embed.url !== "string")
            throw new Error(chalk_1.default.red(`[@m3rcena/weky] ${GameName} Error:`) + " Embed URL must be a string.");
    ...
    if (options.embed.author) {
        if (typeof options.embed.author !== "object") {
            throw new Error(chalk_1.default.red(`[@m3rcena/weky] ${GameName} Error:`) + " Embed author must be an object.");
        }
        ;
        ...
        if (options.embed.author.icon_url) {
            if (typeof options.embed.author.icon_url !== "string")
                throw new Error(chalk_1.default.red(`[@m3rcena/weky] ${GameName} Error:`) + " Embed author icon URL must be a string.");
        ...
        if (options.embed.author.url) {
            if (typeof options.embed.author.url !== "string")
                throw new Error(chalk_1.default.red(`[@m3rcena/weky] ${GameName} Error:`) + " Embed author URL must be a string.");
    ...
    if (options.embed.description) {
        if (typeof options.embed.description !== "string") {
            throw new Error(chalk_1.default.red(`[@m3rcena/weky] ${GameName} Error:`) + " Embed description must be a string.");
        }
    ...
    if (options.embed.fields) {
        if (!Array.isArray(options.embed.fields)) {
            throw new Error(chalk_1.default.red(`[@m3rcena/weky] ${GameName} Error:`) + " Embed fields must be an array.");
        }
        ;
        for (const field of options.embed.fields) {
            if (typeof field !== "object") {
                throw new Error(chalk_1.default.red(`[@m3rcena/weky] ${GameName} Error:`) + " Embed field must be an object.");
            }
            ;
            if (!field.name)
            ...
            if (field.name) {
                if (typeof field.name !== "string")
                    throw new Error(chalk_1.default.red(`[@m3rcena/weky] ${GameName} Error:`) + " Field name must be a string.");
            ...
            if (field.value) {
                if (typeof field.value !== "string")
                    throw new Error(chalk_1.default.red(`[@m3rcena/weky] ${GameName} Error:`) + " Field value must be a string.");
            ...
            if (field.inline && typeof field.inline !== "boolean") {
                throw new Error(chalk_1.default.red(`[@m3rcena/weky] ${GameName} Error:`) + " Embed field inline must be a boolean.");
            }
            ;
        }
        ;
    ...
    if (options.embed.image) {
        if (typeof options.embed.image !== "string")
            throw new Error(chalk_1.default.red(`[@m3rcena/weky] ${GameName} Error:`) + " Embed image must be a string.");
    ...
    if (options.embed.timestamp && !(options.embed.timestamp instanceof Date)) {
        throw new Error(chalk_1.default.red(`[@m3rcena/weky] ${GameName} Error:`) + " Embed timestamp must be a date.");
    }
    ;
}
