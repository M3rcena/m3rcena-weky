 ...
 */
var QuickClick = (options) => index.__awaiter(void 0, void 0, void 0, function* () {
    if (!options.message) {
    ...
    if (currentGames[options.message.guild.id]) {
        const embed = new discord_js.EmbedBuilder()
            ...
            .setDescription(options.ongoingMessage.replace('{{channel}}', currentGames[`${options.message.guild.id}_channel`]));
        if (options.embed.timestamp) {
            embed.setTimestamp();
        }
    ...
    const msg = yield options.message.reply({ embeds: [embed] });
    ...
    setTimeout(function () {
        return index.__awaiter(this, void 0, void 0, function* () {
            ...
            const _embed = new discord_js.EmbedBuilder()
                ...
                .setAuthor({ name: options.message.author.username, iconURL: options.message.author.displayAvatarURL() })
                .setFooter({ text: options.embed.footer })
                .setDescription(options.startMessage.replace('{{time}}', _function.convertTime(options.time)));
            if (options.embed.timestamp) {
                _embed.setTimestamp();
            }
            yield msg.edit({
            ...
            Collector.on('collect', (button) => index.__awaiter(this, void 0, void 0, function* () {
            ...
            Collector.on('end', (_msg, reason) => index.__awaiter(this, void 0, void 0, function* () {
                if (reason === 'time') {
                    buttons.forEach((element) => {
                        element.setDisabled();
                    });
