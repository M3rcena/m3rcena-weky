 ...
 */
var ShuffleGuess = (options) => index.__awaiter(void 0, void 0, void 0, function* () {
    if (!options.message) {
    ...
    if (!options.word)
        options.word = _function.getRandomSentence(1);
    if (!options.button)
        options.button = {};
    ...
    const embed = yield options.message.reply({
        embeds: [emd],
        components: [
            {
                type: 1,
    ...
    GameCollector.on('collect', (btn) => index.__awaiter(void 0, void 0, void 0, function* () {
        ...
        if (btn.customId === id1) {
            const _embed = new discord_js.EmbedBuilder()
                ...
                .setFooter({ text: options.embed.footer })
                .setDescription(options.startMessage
                .replace('{{word}}', _function.shuffleString(options.word.toString()))
                .replace('{{time}}', _function.convertTime(options.time)));
            if (options.embed.timestamp) {
                _embed.setTimestamp();
            }
            ...
            const _embed = new discord_js.EmbedBuilder()
                ...
                .setAuthor({ name: options.message.author.username, iconURL: options.message.author.displayAvatarURL() })
                .setFooter({ text: options.embed.footer })
                .setDescription(options.loseMessage.replace('{{answer}}', options.word.toString()));
            if (options.embed.timestamp) {
                _embed.setTimestamp();
            }
            return embed.edit({
    ...
    gameCollector.on('end', (_collected, reason) => index.__awaiter(void 0, void 0, void 0, function* () {
        if (reason === 'time') {
            disbut = new discord_js.ButtonBuilder()
                .setLabel(options.button.reshuffle)
                .setCustomId(id1)
